...
class BaddieBotAgent(botbowl.Agent):
    BOT_ID = 'Baddie'
    ...
    def register_bot(path=ConfigParams.model_path.value):
        ...
        """
        if BaddieBotAgent.BOT_ID.lower() not in botbowl.list_bots():
            botbowl.register_bot(BaddieBotAgent.BOT_ID, lambda name: BaddieBotAgent(name=name, model_path=path))